...
$this->title = $nameSeries . ' ' . Yii::t('app', 'series processors, specifications and tests') . ' '. $strPage;
$this->registerMetaTag(['name' => 'description', 'content' => $nameSeries . ' ' . Yii::t('app', "series processors. Specifications and performance tests") . ' '. $strPage]);
...
$this->params['breadcrumbs'][] = array(
    'label'=> Yii::t('app', 'CPUs groups'),
    'url'=>Yii::$app->urlManager->createUrl('cpu/family'),
);
...
<div class="container">
    ...
    <div class="block">
        ...
        <p><?=$nameSeries . ' ' .Yii::t('app', "CPU list, features and benchmarks in") . ' ' .date('Y')?></p>
            ...
            <div class="rating-table-header">
                <div class="rating-table-item">
                    ...
                    <div class="rating-table-content">
                        <div class="t1">
                            <div class="rating-table-name"><?=Yii::t('app', 'Processor')?></div>
                        </div>
                        <div class="t4">
                            <div class="rating-table-name"><?=Yii::t('app', 'Frequency')?></div>
                        </div>
                        <div class="t4">
                            <div class="rating-table-name"><?=Yii::t('app', 'CPU Cores')?></div>
                        </div>
                        <div class="t5">
                            <div class="rating-table-name"><?=Yii::t('app', 'TDP (PL1)')?></div>
                        </div>
                        <div class="t6">
                    ...
                    <div class="rating-table-item">
                        ...
                        <div class="rating-table-content">
                            <div class="t1">
                                ...
                                <div class="t1-flex">
                                    <img src="" alt="">
                                    <a href="<?= Url::to(['cpu/index', 'alias' => $bench['alias']])?>"><?=$bench['name']?></a>
                                </div>
                            </div>
                            <div class="t4">
                            ...
                            <div class="t4">
                                <div class="rating-table-name">CPU Cores</div>
                                <?=  $bench['cores'] ?>
                            </div>
                            <div class="t5">
                            ...
                            <div class="t6">
                                ...
                                <?=  '<a href="'.Url::to(['cpu/index', 'alias' => $bench['alias']]). '" class="btn btn-yellow">'.Yii::t('app', 'Compare').'</a>' ?>
                            </div>
