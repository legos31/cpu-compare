...
$this->title = Yii::t('app', 'Cinebench R23 processor performance rankings, specifications and scores') . ' ' . $strPage;
$this->registerMetaTag(['name' => 'description', 'content' => Yii::t('app', "Maxon's Cinebench R23 is a cross-platform test suite for macOs and Windows using a multi-core and hyperthreading. The benchmark is based on Cinema 4D Suite") . ' ' . $strPage]);
...
<div class="container">
    ...
    <div class="block">
        ...
        <p><?= Yii::t('app', "Maxon's Cinebench R23 is a cross-platform test suite for macOs and Windows using a multi-core and hyperthreading. The benchmark is based on Cinema 4D Suite. Cinebench R23 offers a real system performance score for common user tasks") ?></p>
