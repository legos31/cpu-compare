...
$this->title = Yii::t('app', 'Crypto-Mining Vertcoin Hashrate GPU performance rankings') . ' ' . $strPage;
$this->registerMetaTag(['name' => 'description', 'content' => Yii::t('app', "VertCoin cryptocurrency can be mined on both Nvidia and AMD and is interesting because it mines perfectly on old GPUs like GTX1050, R9 290 and even GTX970.") . ' ' . $strPage]);
...
<div class="container">
    ...
    <div class="block">
        ...
        <p><?= Yii::t('app', "VertCoin cryptocurrency can be mined on both Nvidia and AMD and is interesting because it mines perfectly on old GPUs like GTX1050, R9 290 and even GTX970. It is based on the Verthash algorithm.") ?></p>
