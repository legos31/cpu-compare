...
$this->title = Yii::t('app', 'Crypto-Mining Ethereum Hashrate GPU performance rankings') . ' ' . $strPage;
$this->registerMetaTag(['name' => 'description', 'content' => Yii::t('app', "Ethash is an algorithm for mining Ethereum cryptocurrency that makes the most of the GPU.") . ' ' . $strPage]);
...
<div class="container">
    ...
    <div class="block">
        ...
        <p><?= Yii::t('app', "Ethash is an algorithm for mining Ethereum cryptocurrency that makes the most of the GPU.") ?></p>
