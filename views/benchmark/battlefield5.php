...
$this->title = Yii::t('app', 'Battlefield 5 GPU performance rankings, specifications GPUs and scores') . ' ' . $strPage;
$this->registerMetaTag(['name' => 'description', 'content' => Yii::t('app', "Battlefield 5 is a realistic game, with a built-in benchmark, very suitable as a test for graphics cards.") . ' ' .  $strPage]);
...
<div class="container">
    ...
    <div class="block">
        ...
        <p><?= Yii::t('app', "Battlefield 5 is a realistic game, with a built-in benchmark, very suitable as a test for graphics cards. The engine is available for Windows, PS4, PS5, XBox One or XBox Series X.") ?></p>
        <p><?= Yii::t('app', "The test is conducted with a screen resolution of 3840x2160. DirectX12, Win10 environment.") ?></p>
