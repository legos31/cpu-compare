...
$this->title = Yii::t('app', 'FP32 GPU performance rankings, specifications GPUs and scores') . ' ' . $strPage;
$this->registerMetaTag(['name' => 'description', 'content' => Yii::t('app', "Benchmark FP32 is a 32-bit floating point calculation for the GPU which is required for 3D gaming.") . ' ' . $strPage]);
...
<div class="container">
    ...
    <div class="block">
        ...
        <p><?= Yii::t('app', "Benchmark FP32 is a 32-bit floating point calculation for the GPU which is required for 3D gaming. The result is affected by the speed of the memory bandwidth and its speed (Single-precision TFLOPS)") ?></p>
