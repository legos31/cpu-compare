...
$this->title = Yii::t('app', 'Intel processor performance rankings, specifications CPU and scores') . ' ' . $strPage;
$this->registerMetaTag(['name' => 'description', 'content' => Yii::t('app', "Intel processor performance rankings, specifications CPU and scores. Calculated from the most popular tests CPU.") . ' ' . $strPage]);
...
<div class="container">
    ...
    <div class="block">
        <div class="title mb-30">
            <h1 class="big-compare-name" style="margin-top:15px;margin-bottom:25px;"><?= Yii::t('app', 'Intel processor performance rankings') ?></h1>
        </div>
        <p><?= Yii::t('app', "Intel processor performance rankings, specifications CPU and scores. Calculated from the most popular tests CPU.") ?></p>
