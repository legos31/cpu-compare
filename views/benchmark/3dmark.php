...
$this->title = Yii::t('app', '3DMark GPU performance rankings, specifications GPUs and scores')  . ' ' . $strPage;
$this->registerMetaTag(['name' => 'description', 'content' => Yii::t('app', "3DMark is designed for gamers, overclockers and system builders who want to get the most out of their hardware.")  . ' ' .  $strPage]);
...
<div class="container">
    ...
    <div class="block">
        ...
        <p><?= Yii::t('app', "3DMark is designed for gamers, overclockers and system builders who want to get the most out of their hardware. There are many tests in 3DMark that you can use to test the performance of your PC.") ?></p>
