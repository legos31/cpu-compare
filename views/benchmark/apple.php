...
$this->title = Yii::t('app', 'Apple processor performance rankings, specifications CPU and scores') . ' ' . $strPage;
$this->registerMetaTag(['name' => 'description', 'content' => Yii::t('app', "Apple processor performance rankings, specifications CPU and scores. Calculated from the most popular tests CPU.") . ' ' . $strPage]);
...
<div class="container">
    ...
    <div class="block">
        <div class="title mb-30">
            <h1 class="big-compare-name" style="margin-top:15px;margin-bottom:25px;"><?= Yii::t('app', 'Apple processor performance rankings') ?></h1>
        </div>
        <p><?= Yii::t('app', "Apple processor performance rankings, specifications CPU and scores. Calculated from the most popular tests CPU.") ?></p>
            ...
            <div class="rating-table-header">
                <div class="rating-table-item">
                    ...
                    <div class="rating-table-content">
                        ...
                        <div class="t2">
                            <div class="rating-table-name">Points</div>
                        </div>
