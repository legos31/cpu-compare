...
$this->title = Yii::t('app', 'Crypto-Mining Ravencoin Hashrate GPU performance rankings')  . ' ' . $strPage;
$this->registerMetaTag(['name' => 'description', 'content' => Yii::t('app', "Hashrate mining Ravencoin cryptocurrency on the KawPoW algorithm is fastest on modern video cards.")  . ' ' . $strPage]);
...
<div class="container">
    ...
    <div class="block">
        ...
        <p><?= Yii::t('app', "Hashrate mining Ravencoin cryptocurrency on the KawPoW algorithm is fastest on modern video cards.") ?></p>
