...
$this->title = $benchName . ' ' . Yii::t('app', 'GPU performance rating')  . ' ' . '| cpu-compare' . ' ' . $strPage;
$this->registerMetaTag(['name' => 'description', 'content' => $benchName . ' ' . Yii::t('app', 'GPU performance rating')  . '. ' . Yii::t('app', 'Choose the best graphics cards according to the test results') . ' ' . $strPage]);
...
<div class="container">
    ...
    ?>
    <div class="block">
        <h1 style="font-size: 1.8rem;"><?= Yii::t('app', 'Overall GPU performance ranking') ?></h1>
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    ...
                    'format' => 'raw',
                    'value' => function ($data) {
                        if (isset($data->gpu->image)) {
                            return '<img src="' . $data->gpu->image . '" style="width: 35px;">';
                        } else {
                            return 'No foto';
                        }
                    },
                ...
                [
                    ...
                    'value' => function ($data) {
                        if ($data->gpu) {
                            return '<div class="t6"><div class="rating-table-name"></div>' .
                                Html::a(
                                    Yii::t('app', 'Compare'),
                                    Url::to(['gpu/index', 'alias' => $data->gpu->alias]),
                                    [
