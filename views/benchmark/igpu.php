...
$this->title = Yii::t('app', 'iGPU - FP32 processor performance rankings, specifications and scores') . ' ' . $strPage;
$this->registerMetaTag(['name' => 'description', 'content' => Yii::t('app', 'The performance of the iGPU - the internal GPU in games. GFLOPS indicates the number of billions of operations per second that the iGPU is capable of performing') . ' ' . $strPage]);
...
<div class="container">
    ...
    <div class="block">
        ...
        <p><?= Yii::t('app', 'The performance of the iGPU - the internal GPU in games. GFLOPS indicates the number of billions of operations per second that the iGPU is capable of performing') ?></p>
            ...
            <div class="rating-table-header">
                <div class="rating-table-item">
                    ...
                    <div class="rating-table-content">
                        ...
                        <div class="t2">
                            <div class="rating-table-name">GFLOPS</div>
                        </div>
                        <div class="t3">
