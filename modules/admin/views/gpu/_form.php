    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4">
                    <?= $form->field($model, 'type')->dropDownList(['Desktop' => 'Desktop', 'Laptop' => 'Laptop']) ?>
                </div>
                <div class="col-md-6 col-lg-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <?= $form->field($model, 'memory_size')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-md-6 col-lg-4">
                    <?= $form->field($model, 'memory_type')->textInput(['maxlength' => true]) ?>
                </div>
                <div class="col-md-6 col-lg-4">
