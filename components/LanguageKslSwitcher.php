...
class LanguageKslSwitcher extends Widget{
    ...
    public function init() {
        ...
        foreach (Yii::$app->getModule('languages')->languages as $key => $value){
            $array_lang += [$value => Html::a('<img src="/images/flags/'.$value.'.svg" alt="'.$key.'">'.$key, ['languages/default/index', 'lang' => $value], ['class' => 'lang-switcher-item'])];
        }
